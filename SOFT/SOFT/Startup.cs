...
namespace startApp
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //services.AddRazorPages();//umesto toga ovo:
            
            services.AddMvc(options=>
            {
                //ovo mnogo bitna linija
            ...
            }).AddRazorPagesOptions(options=>
            {
                ...
                options.Conventions.AllowAnonymousToPage("/ViewMobilni");
                options.Conventions.AllowAnonymousToPage("/Pretraga"); 
            });
